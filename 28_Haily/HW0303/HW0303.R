#2.22
  #a.Regression model_totalscore/small
    ...
    library(dplyr)
    classsize <- filter(star5_small,small==1|regular==1)
    Reg22.a <- lm(totalscore~small,data=classsize)
  #for輸出好看的表格
